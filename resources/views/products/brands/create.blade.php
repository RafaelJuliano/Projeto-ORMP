...
@section('content')
    <section class="body">        
        ...
        <nav class="body-nav">
            <a class="body-menu" href=""> <h2>Cadastrar Marca</h2> </a>
        ...
        <form class="create-form" method="post" action="{{ route('marcas.store') }}">
            {{ csrf_field() }}
            ...
            <div class="form-line">
                ...
                <div class="form-item form-large">
                    ...
                    <input type="text" name="name" id="name" placeholder="Ex. Intel">
                </div>   
            </div>         
